<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="payment.aspx.cs" Inherits="Project_2.payment" %>
<!DOCTYPE html>
...
<body>
    <form runat ="server">
    <div class = "loginbox">
        <asp:Label ID="Label1" runat="server" Text ="payments at concert" style="font-size: x-large; font-weight: 700" CssClass="auto-style1"></asp:Label>
        <br />
        <br />
